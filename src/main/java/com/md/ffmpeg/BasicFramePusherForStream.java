...
//基本的推流器
public class BasicFramePusherForStream implements IFramePusher {
    ...
    public BasicFramePusherForStream(String rtmpPath) {
        this.rtmpPath = rtmpPath;
    }

    public BasicFramePusherForStream(String rtmpPath, IFrameMerger frameMerger) {
        this.rtmpPath = rtmpPath;
    ...
    private void openRecorder() {
        try {
            recorder = new FFmpegFrameRecorder(rtmpPath, 400, 300);
...
//                    {
//                        System.out.println("XXXXXXXXXXXVVVVV推帧器推流一视频帧时间戳早于当前时间戳...."+frame.timestamp+" ,当前时间戳："+recorder.getTimestamp());
...
//                    {
//                        System.out.println("XXXXXXXXXXX推帧器推流一音频帧时间戳早于当前时间戳...."+frame.timestamp+" ,当前时间戳："+recorder.getTimestamp());
////                        lastTimeStamp=recorder.getTimestamp();
////                        frame.timestamp=lastTimeStamp;
//                        continue;
//                    }
