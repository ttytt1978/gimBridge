...
public class VideoAudioFrameTaker implements IFrameTaker {
    ...
    public VideoAudioFrameTaker(String streamPath) {
        this.streamPath = streamPath;
        frameQue = new ConcurrentLinkedQueue<Frame>();
    }

    public VideoAudioFrameTaker(String streamPath, int capacity) {
        this(streamPath);
