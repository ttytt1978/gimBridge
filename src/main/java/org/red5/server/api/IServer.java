...
public interface IServer {
    ...
    /**
     * Add com.listener to get notified about scope events.
     * 
     * @param listener
     *            the com.listener to add
     */
    public void addListener(IScopeListener listener);

    /**
     * Add com.listener to get notified about connection events.
     * 
     * @param listener
     *            the com.listener to add
     */
    ...
    /**
     * Remove com.listener that got notified about scope events.
     * 
     * @param listener
     *            the com.listener to remove
     */
    public void removeListener(IScopeListener listener);

    /**
     * Remove com.listener that got notified about connection events.
     * 
     * @param listener
     *            the com.listener to remove
     */
