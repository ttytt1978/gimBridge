 ...
 */
public abstract class BasicScope extends PersistableAttributeStore implements IBasicScope, Comparable<BasicScope> {
    ...
    public BasicScope(IScope parent, ScopeType type, String name, boolean persistent) {
    	super("scope", name, null, persistent);
        this.parent = parent;
        this.type = type;
        this.name = name;
    ...
    /**
     * Add event com.listener to list of notified objects
     * 
     * @param listener Listening object
     * @return true if com.listener is added and false otherwise
     */
    ...
    /**
     * Remove event com.listener from list of listeners
     * 
     * @param listener
     *            Listener to remove
     * @return true if com.listener is removed and false otherwise
     */
    ...
    public int compareTo(BasicScope that) {
        ...
        if (c == 0) {
            ...
            c = type.toString().compareTo(that.getType());
            if (c == 0) {
