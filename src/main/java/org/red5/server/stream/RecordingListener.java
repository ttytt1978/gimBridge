...
/**
 * Stream com.listener for recording stream events to a file.
 *
    ...
    **/
    ...
    public void stop() {
        ...
        if (recording.compareAndSet(true, false)) {
            ...
            log.debug("Recording com.listener was already stopped");
        }
    }
    ...
    public void packetReceived(IBroadcastStream stream, IStreamPacket packet) {
        if (recording.get()) {
            ...
            log.info("A packet was received by recording com.listener, but it's not recording anymore. {}", stream.getPublishedName());
        }
    }
