...
public class ExtConfiguration{
	...
	public  void setRTMPS_TRUSTSTOREFILE(String rTMPS_TRUSTSTOREFILE) {
		RTMPS_TRUSTSTOREFILE = rTMPS_TRUSTSTOREFILE;
	}
	
	@Value("${rtmps.truststorepass}")
	public  void setRTMPS_TRUSTSTOREPASS(String rTMPS_TRUSTSTOREPASS) {
		RTMPS_TRUSTSTOREPASS = rTMPS_TRUSTSTOREPASS;
	}
	
	
	@Value("${rtmps.keystorefile}")
	public  void setRTMPS_KEYSTOREFILE(String rTMPS_KEYSTOREFILE) {
		RTMPS_KEYSTOREFILE = rTMPS_KEYSTOREFILE;
	}
	
	@Value("${rtmps.keystorepass}")
	public  void setRTMPS_KEYSTOREPASS(String rTMPS_KEYSTOREPASS) {
		RTMPS_KEYSTOREPASS = rTMPS_KEYSTOREPASS;
	}
	
	@Value("${rtmps.processor_cache}")
	public  void setRTMPS_PROCESSOR_CACHE(int rTMPS_PROCESSOR_CACHE) {
		RTMPS_PROCESSOR_CACHE = rTMPS_PROCESSOR_CACHE;
	}
	
	@Value("${rtmps.acceptor_thread_count}")
	public  void setRTMPS_ACCEPTOR_THREAD_COUNT(int rTMPS_ACCEPTOR_THREAD_COUNT) {
		RTMPS_ACCEPTOR_THREAD_COUNT = rTMPS_ACCEPTOR_THREAD_COUNT;
	}
	
	
	@Value("${rtmps.max_threads}")
	public  void setRTMPS_MAX_THREADS(int rTMPS_MAX_THREADS) {
		RTMPS_MAX_THREADS = rTMPS_MAX_THREADS;
	}
	
	@Value("${rtmps.max_keep_alive_requests}")
	public  void setRTMPS_MAX_KEEP_ALIVE_REQUESTS(int rTMPS_MAX_KEEP_ALIVE_REQUESTS) {
		RTMPS_MAX_KEEP_ALIVE_REQUESTS = rTMPS_MAX_KEEP_ALIVE_REQUESTS;
	}
	
	
	@Value("${rtmps.max_inactivity}")
	public  void setRTMPS_MAX_INACTIVITY(int rTMPS_MAX_INACTIVITY) {
		RTMPS_MAX_INACTIVITY = rTMPS_MAX_INACTIVITY;
	}
	
	
	@Value("${rtmps.host}")
	public  void setRTMPS_HOST(String rTMPS_HOST) {
		RTMPS_HOST = rTMPS_HOST;
	}
	
	@Value("${rtmps.port}")
	public  void setRTMPS_PORT(int rTMPS_PORT) {
		RTMPS_PORT = rTMPS_PORT;
	}
	
	@Value("${rtmps.ping_interval}")
	public  void setRTMPS_PING_INTERVAL(int rTMPS_PING_INTERVAL) {
		RTMPS_PING_INTERVAL = rTMPS_PING_INTERVAL;
	}
