...
/**
 * A servlet context com.listener that puts this contexts LoggerContext into a static map of logger contexts within an overall singleton log context selector.
 * 
 * To use it, add the following line to a web.xml file
 *
 * <pre>
 * 	&lt;com.listener&gt;
 * 		&lt;com.listener-class&gt;org.red5.logging.ContextLoggingListener&lt;/com.listener-class&gt;
 * 	&lt;/com.listener&gt;
 * </pre>
 *
