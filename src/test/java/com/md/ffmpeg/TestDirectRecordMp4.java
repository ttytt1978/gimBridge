...
public class TestDirectRecordMp4 {
...
//        FFmpegFrameRecorder recorder = new FFmpegFrameRecorder("rtmp://127.0.0.1/oflaDemo/stream19", 800, 600);
        FFmpegFrameRecorder recorder = new FFmpegFrameRecorder("c:\\test1.mp4", 400, 300);
...
//            avframe.pkt_duration(duration);
    ...
    public static void testDirectGrab2AndRecordMp4File()throws Exception
    {
        int audioChannels=1;
        int sampleRate=48000;
        FFmpegFrameGrabber grabber1=new FFmpegFrameGrabber("rtmp://127.0.0.1/oflaDemo/stream11");
        ...
        while(true)
        {
           ...
           if(frame1.image!=null)
           {
               ...
               if(mergedFrame!=null)
               {
                   ...
                   {
                       recorder.record(mergedFrame);
                       System.out.println("record one  mixed video frame1..."+curTimestamp);
                   }catch (Exception e)
                   {
...
//            filter.setAudioInputs(1);
    ...
    {
        BasicFrameTaker taker1=new BasicFrameTaker("rtmp://127.0.0.1/oflaDemo/stream11",200);
        BasicFrameTaker taker2=new BasicFrameTaker("rtmp://127.0.0.1/oflaDemo/stream12",200);

        IFrameMerger merger=new TwoStreamFrameMergerForMp4(500);
//        IFrameMerger merger=new TwoStreamSimpleFrameMerger(10);
        merger.setFrameTakers(taker1,taker2);

        IFramePusher pusher=new BasicFramePusherForStream("rtmp://127.0.0.1/oflaDemo/stream19");
    ...
    {
        BasicFrameTaker taker1=new BasicFrameTaker("rtmp://127.0.0.1/oflaDemo/stream12",300);
        BasicFrameTaker taker2=new BasicFrameTaker("rtmp://127.0.0.1/oflaDemo/stream11",300);

//        IFrameMerger merger=new TwoStreamOneAudioFrameMergerCopy(300);
        IFrameMerger merger=new TwoStreamSimpleFrameMerger(300);
        merger.setFrameTakers(taker1,taker2);

        IFramePusher pusher=new BasicFramePusherForMp4("c:\\test.mp4");
        pusher.setFrameMerger(merger);
        pusher.start();
        try {
